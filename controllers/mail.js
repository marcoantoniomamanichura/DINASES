...
function send_mail( res, destination_mail, message_passw){
    ...
    var transporter = nodemailer.createTransport({
        service: 'Gmail',
        auth: {
            user: 'BiopetrolAguasok@gmail.com',
            pass: '*123456789'
        }
    });
...
var mailOptions = {
    ...
    subject: 'AGUAS OK', // Subject line
    text: '', // plaintext body
    html: '<div style="width:94%;float:left;display:block;text-align:center;margin:3%;border:1px solid #efefef;border-radius:10px"><div style="width:100%;float:left;display:block;text-align:center"><img src="http://190.180.84.22:8000/icono/aguasok.png" height="180px" style="margin:2.5%" class="CToWUd a6T" tabindex="0"><div class="a6S" dir="ltr" style="opacity: 0.01; left: 311.438px; top: 170.2px;"><div id=":le" class="T-I J-J5-Ji aQv T-I-ax7 L3 a5q" role="button" tabindex="0" aria-label="Descargar el archivo adjunto " data-tooltip-class="a1V" data-tooltip="Descargar"><div class="aSK J-J5-Ji aYr"></div></div></div><div style="font-size:22px;background-color:#313b42;width:96%;float:left;display:block;text-align:center;color:#fff;padding:2%">RESTAURACION DE CONTRASEÑA</div></div><div style="width:90%;float:left;display:block;text-align:center;padding:5%;font-size:18px">Señor usuario se le ha generado una nueva contraseña <br><span style="color:#ff;font-weight:bold;font-size:24px">'+message_passw+'</span></div><div style="width:95%;float:left;display:block;text-align:right;padding:2.5%">EMPRESA DE DESARROLLO DE SOFWTARE  DINASES SRL - 2017</div></div>' // html body
};
